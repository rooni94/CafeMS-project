...
INTENT_KEYWORDS = {
    "greeting": ["هلا", "مرحبا", "ياهلا", "أهلا", "سلام", "السلام عليكم"],
    "smalltalk_howareyou": ["كيف حالك", "كيفك", "كيف الحال", "شلونك", "اخبارك", "ايش اخبارك"],
    ...
    "recommendation": ["اقترح", "وش تنصح", "اختار لي", "اختيار مشروب", "اقتراح قهوة"],
    ...
    "cancel_order": ["الغاء", "الغي", "الغيه", "كنسل", "ابغى الغي", "أبغى الغي", "ابي الغي", "أبي الغي", "ألغيه"],
...
SMALL_TALK = {
    ...
    "smalltalk_joke": "أبشر 😄 نكتة سريعة: واحد سأل باريستا عن سر القهوة الحلوة، قال له: لا تستعجلها 😂. نرجع لطلبك؟",
    ...
    "smalltalk_personal": "أنا مساعد المتجر 🤝 أساعدك تختار وتطلب وتتابع طلباتك.",
}
...
COMPLAINTS = {
    ...
    "cold": "آسفين جدًا 😔 تبغى نراجع لك طلب المشروب أو الحلى؟ وعطني رقم الطلب.",
